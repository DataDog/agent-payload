...
type Connections struct {
	...
	ConnLen                     int64                                   `protobuf:"varint,13,opt,name=ConnLen,proto3" json:"ConnLen,omitempty"`
}
...
func (m *Connections) MarshalTo(data []byte) (int, error) {
	...
	if m.ConnLen != 0 {
		data[i] = 0x68
		i++
		i = encodeVarintConnections(data, i, uint64(m.ConnLen))
	}
	return i, nil
}
...
func (m *Connections) Size() (n int) {
	...
	if m.ConnLen != 0 {
		n += 1 + sovConnections(uint64(m.ConnLen))
	}
	return n
}
...
func (m *Connections) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConnLen", wireType)
			}
			m.ConnLen = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorConnections = []byte{
	...
	,
}
