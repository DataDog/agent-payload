...
type HTTPStats_Data struct {
	...
	Latencies [][]byte `protobuf:"bytes,2,rep,name=latencies" json:"latencies,omitempty"`
}
...
func (m *HTTPStats_Data) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Latencies) > 0 {
		for _, b := range m.Latencies {
			data[i] = 0x12
			i++
			i = encodeVarintAgent(data, i, uint64(len(b)))
			i += copy(data[i:], b)
		}
	}
	return i, nil
...
func (m *HTTPStats_Data) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Latencies = append(m.Latencies, make([]byte, postIndex-iNdEx))
			copy(m.Latencies[len(m.Latencies)-1], data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAgent(data[iNdEx:])
...
var fileDescriptorAgent = []byte{
	...
	,
}
