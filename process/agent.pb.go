...
type CollectorConnections struct {
	...
	// Mapping of IP address to DNS entries. Key is the IP Byte String format.
...
type Addr struct {
	...
	IpByteString string `protobuf:"bytes,7,opt,name=ipByteString,proto3" json:"ipByteString,omitempty"`
...
type IPTranslation struct {
	...
	ReplSrcIPByteString string `protobuf:"bytes,5,opt,name=replSrcIPByteString,proto3" json:"replSrcIPByteString,omitempty"`
	...
	ReplDstIPByteString string `protobuf:"bytes,6,opt,name=replDstIPByteString,proto3" json:"replDstIPByteString,omitempty"`
...
func (m *Addr) MarshalTo(data []byte) (int, error) {
	...
	if len(m.IpByteString) > 0 {
		data[i] = 0x3a
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.IpByteString)))
		i += copy(data[i:], m.IpByteString)
	}
	return i, nil
}
...
func (m *IPTranslation) MarshalTo(data []byte) (int, error) {
	...
	if len(m.ReplSrcIPByteString) > 0 {
		data[i] = 0x2a
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.ReplSrcIPByteString)))
		i += copy(data[i:], m.ReplSrcIPByteString)
	}
	if len(m.ReplDstIPByteString) > 0 {
		data[i] = 0x32
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.ReplDstIPByteString)))
		i += copy(data[i:], m.ReplDstIPByteString)
	}
	return i, nil
}
...
func (m *IPTranslation) Size() (n int) {
	...
	l = len(m.ReplSrcIPByteString)
	if l > 0 {
		n += 1 + l + sovAgent(uint64(l))
	}
	l = len(m.ReplDstIPByteString)
	if l > 0 {
		n += 1 + l + sovAgent(uint64(l))
	}
	return n
...
func (m *Addr) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IpByteString", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IpByteString = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAgent(data[iNdEx:])
...
func (m *IPTranslation) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplSrcIPByteString", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReplSrcIPByteString = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplDstIPByteString", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReplDstIPByteString = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAgent(data[iNdEx:])
...
var fileDescriptorAgent = []byte{
	...
	,
}
