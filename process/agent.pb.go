...
type CollectorPersistentVolume struct {
	...
	GroupId          int32               `protobuf:"varint,3,opt,name=groupId,proto3" json:"groupId,omitempty"`
	GroupSize        int32               `protobuf:"varint,4,opt,name=groupSize,proto3" json:"groupSize,omitempty"`
	PersistentVolume []*PersistentVolume `protobuf:"bytes,5,rep,name=persistentVolume" json:"persistentVolume,omitempty"`
	Tags             []string            `protobuf:"bytes,6,rep,name=tags" json:"tags,omitempty"`
}
...
func (m *CollectorPersistentVolume) GetPersistentVolume() []*PersistentVolume {
	if m != nil {
...
type CollectorPersistentVolumeClaim struct {
	...
	GroupId               int32                    `protobuf:"varint,3,opt,name=groupId,proto3" json:"groupId,omitempty"`
	GroupSize             int32                    `protobuf:"varint,4,opt,name=groupSize,proto3" json:"groupSize,omitempty"`
	PersistentVolumeClaim []*PersistentVolumeClaim `protobuf:"bytes,5,rep,name=persistentVolumeClaim" json:"persistentVolumeClaim,omitempty"`
	Tags                  []string                 `protobuf:"bytes,6,rep,name=tags" json:"tags,omitempty"`
}
...
func (m *CollectorPersistentVolumeClaim) GetPersistentVolumeClaim() []*PersistentVolumeClaim {
	if m != nil {
...
type PersistentVolumeSpec struct {
	...
	PersistentVolumeSource        string              `protobuf:"bytes,2,opt,name=persistentVolumeSource,proto3" json:"persistentVolumeSource,omitempty"`
	...
	MountOptions                  string              `protobuf:"bytes,7,opt,name=mountOptions,proto3" json:"mountOptions,omitempty"`
	VolumeMode                    string              `protobuf:"bytes,8,opt,name=volumeMode,proto3" json:"volumeMode,omitempty"`
	NodeSelectorTerms             []*NodeSelectorTerm `protobuf:"bytes,9,rep,name=nodeSelectorTerms" json:"nodeSelectorTerms,omitempty"`
}
...
func (m *PersistentVolumeSpec) GetNodeSelectorTerms() []*NodeSelectorTerm {
	if m != nil {
...
type PersistentVolumeClaimStatus struct {
	Phase       string                            `protobuf:"bytes,1,opt,name=phase,proto3" json:"phase,omitempty"`
	AccessModes string                            `protobuf:"bytes,2,opt,name=accessModes,proto3" json:"accessModes,omitempty"`
...
type PersistentVolumeClaimSpec struct {
	...
	Selector         *LabelSelectorRequirement  `protobuf:"bytes,4,opt,name=selector" json:"selector,omitempty"`
...
func (m *PersistentVolumeClaimSpec) GetDataSourceRef() *TypedLocalObjectReference {
	if m != nil {
...
func (m *CollectorPersistentVolume) MarshalTo(data []byte) (int, error) {
	...
	if len(m.PersistentVolume) > 0 {
		for _, msg := range m.PersistentVolume {
			data[i] = 0x2a
			i++
			i = encodeVarintAgent(data, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(data[i:])
...
func (m *CollectorPersistentVolumeClaim) MarshalTo(data []byte) (int, error) {
	...
	if len(m.PersistentVolumeClaim) > 0 {
		for _, msg := range m.PersistentVolumeClaim {
			data[i] = 0x2a
			i++
			i = encodeVarintAgent(data, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(data[i:])
...
func (m *PersistentVolumeSpec) MarshalTo(data []byte) (int, error) {
	...
	if len(m.PersistentVolumeSource) > 0 {
		data[i] = 0x12
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.PersistentVolumeSource)))
		i += copy(data[i:], m.PersistentVolumeSource)
	}
	...
	if len(m.MountOptions) > 0 {
		data[i] = 0x3a
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.MountOptions)))
		i += copy(data[i:], m.MountOptions)
	}
...
func (m *PersistentVolumeClaimStatus) MarshalTo(data []byte) (int, error) {
	...
	if len(m.AccessModes) > 0 {
		data[i] = 0x12
		i++
		i = encodeVarintAgent(data, i, uint64(len(m.AccessModes)))
		i += copy(data[i:], m.AccessModes)
	}
	if len(m.Capacity) > 0 {
		for k, _ := range m.Capacity {
			data[i] = 0x1a
...
func (m *PersistentVolumeClaimSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.Selector != nil {
		data[i] = 0x22
		i++
		i = encodeVarintAgent(data, i, uint64(m.Selector.Size()))
	...
	if m.DataSourceRef != nil {
		data[i] = 0x42
		i++
		i = encodeVarintAgent(data, i, uint64(m.DataSourceRef.Size()))
		n74, err := m.DataSourceRef.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n74
...
func (m *CollectorPersistentVolume) Size() (n int) {
	...
	if len(m.PersistentVolume) > 0 {
		for _, e := range m.PersistentVolume {
			l = e.Size()
			n += 1 + l + sovAgent(uint64(l))
		}
	}
...
func (m *CollectorPersistentVolumeClaim) Size() (n int) {
	...
	if len(m.PersistentVolumeClaim) > 0 {
		for _, e := range m.PersistentVolumeClaim {
			l = e.Size()
			n += 1 + l + sovAgent(uint64(l))
		}
	}
...
func (m *PersistentVolumeSpec) Size() (n int) {
	...
	l = len(m.PersistentVolumeSource)
	if l > 0 {
		n += 1 + l + sovAgent(uint64(l))
	}
	if len(m.AccessModes) > 0 {
...
func (m *CollectorPersistentVolume) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.PersistentVolume = append(m.PersistentVolume, &PersistentVolume{})
			if err := m.PersistentVolume[len(m.PersistentVolume)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *CollectorPersistentVolumeClaim) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.PersistentVolumeClaim = append(m.PersistentVolumeClaim, &PersistentVolumeClaim{})
			if err := m.PersistentVolumeClaim[len(m.PersistentVolumeClaim)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *PersistentVolumeSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PersistentVolumeSource = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *PersistentVolumeClaimStatus) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.AccessModes = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Capacity", wireType)
...
func (m *PersistentVolumeClaimSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.Selector == nil {
				m.Selector = &LabelSelectorRequirement{}
			}
...
var fileDescriptorAgent = []byte{
	...
	,
}
