...
type Connection struct {
	...
	DnsErorCount       map[uint32]uint32 `protobuf:"bytes,32,rep,name=dnsErorCount" json:"dnsErorCount,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (m *Connection) GetDnsErorCount() map[uint32]uint32 {
	if m != nil {
		return m.DnsErorCount
	}
	return nil
}
...
func (m *Connection) MarshalTo(data []byte) (int, error) {
	...
	if len(m.DnsErorCount) > 0 {
		for k, _ := range m.DnsErorCount {
			data[i] = 0x82
			i++
			data[i] = 0x2
			i++
...
func (m *Connection) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 32:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DnsErorCount", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DnsErorCount == nil {
				m.DnsErorCount = make(map[uint32]uint32)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				m.DnsErorCount[mapkey] = mapvalue
			} else {
				var mapvalue uint32
				m.DnsErorCount[mapkey] = mapvalue
			}
...
var fileDescriptorAgent = []byte{
	...
	,
}
