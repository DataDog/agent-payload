...
type Connection struct {
	...
	// httpConnectionIdx corresponds to an index into the 'http' field
	HttpConnectionIdx int32 `protobuf:"varint,35,opt,name=httpConnectionIdx,proto3" json:"httpConnectionIdx,omitempty"`
}
...
type Connections struct {
	...
	Http      []*HTTPConnection     `protobuf:"bytes,5,rep,name=http" json:"http,omitempty"`
}
...
func (m *Connections) GetHttp() []*HTTPConnection {
	if m != nil {
		return m.Http
	}
	return nil
...
type HTTPConnection struct {
	...
	StatsByPath map[string]*HTTPStats `protobuf:"bytes,3,rep,name=statsByPath" json:"statsByPath,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *HTTPConnection) Reset()                    { *m = HTTPConnection{} }
func (m *HTTPConnection) String() string            { return proto.CompactTextString(m) }
func (*HTTPConnection) ProtoMessage()               {}
func (*HTTPConnection) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{57} }

func (m *HTTPConnection) GetSource() *Addr {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *HTTPConnection) GetDest() *Addr {
	if m != nil {
		return m.Dest
	}
	return nil
...
func (m *HTTPConnection) GetStatsByPath() map[string]*HTTPStats {
	if m != nil {
		return m.StatsByPath
	}
	return nil
}
...
func (*HTTPStats) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{58} }
...
func (*HTTPStats_Data) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{58, 0} }
...
func init() {
	...
	proto.RegisterType((*HTTPConnection)(nil), "datadog.process_agent.HTTPConnection")
...
func (m *Connection) MarshalTo(data []byte) (int, error) {
	...
	if m.HttpConnectionIdx != 0 {
		data[i] = 0x98
		i++
		data[i] = 0x2
		i++
		i = encodeVarintAgent(data, i, uint64(m.HttpConnectionIdx))
	}
	return i, nil
}
...
func (m *HTTPConnection) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *HTTPConnection) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Dest != nil {
		...
		n45, err := m.Dest.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n45
	}
	if len(m.StatsByPath) > 0 {
		for k, _ := range m.StatsByPath {
			data[i] = 0x1a
			i++
			v := m.StatsByPath[k]
			msgSize := 0
...
func (m *HTTPStats_Data) MarshalTo(data []byte) (int, error) {
	...
	if m.Latencies != nil {
		...
		n47, err := m.Latencies.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *Connection) Size() (n int) {
	...
	if m.HttpConnectionIdx != 0 {
		n += 2 + sovAgent(uint64(m.HttpConnectionIdx))
	}
	return n
}
...
func (m *HTTPConnection) Size() (n int) {
	var l int
	_ = l
	if m.Source != nil {
		l = m.Source.Size()
...
func (m *Connection) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 35:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpConnectionIdx", wireType)
			}
			m.HttpConnectionIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAgent
				}
				...
				b := data[iNdEx]
				iNdEx++
				m.HttpConnectionIdx |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Connections) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Http = append(m.Http, &HTTPConnection{})
...
func (m *HTTPConnection) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HTTPConnection: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HTTPConnection: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatsByPath", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			mapkey := string(data[iNdEx:postStringIndexmapkey])
			iNdEx = postStringIndexmapkey
			if m.StatsByPath == nil {
				m.StatsByPath = make(map[string]*HTTPStats)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorAgent = []byte{
	...
	,
}
