...
func (ProcEventType) EnumDescriptor() ([]byte, []int) { return fileDescriptorEvents, []int{0} }
...
func (*CollectorProcEvent) Descriptor() ([]byte, []int) { return fileDescriptorEvents, []int{0} }
...
func (*ProcessEvent) Descriptor() ([]byte, []int) { return fileDescriptorEvents, []int{1} }
...
func (*ProcessExec) Descriptor() ([]byte, []int) { return fileDescriptorEvents, []int{2} }
...
func (*ProcessExit) Descriptor() ([]byte, []int) { return fileDescriptorEvents, []int{3} }
...
func (m *CollectorProcEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.Host != nil {
		data[i] = 0x12
		i++
		i = encodeVarintEvents(data, i, uint64(m.Host.Size()))
	...
	if m.Info != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintEvents(data, i, uint64(m.Info.Size()))
...
func (m *ProcessEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.Command != nil {
		data[i] = 0x22
		i++
		i = encodeVarintEvents(data, i, uint64(m.Command.Size()))
	...
	if m.User != nil {
		data[i] = 0x2a
		i++
		i = encodeVarintEvents(data, i, uint64(m.User.Size()))
...
func (m *ProcessEvent_Exit) MarshalTo(data []byte) (int, error) {
	...
	if m.Exit != nil {
		data[i] = 0x4a
		i++
		i = encodeVarintEvents(data, i, uint64(m.Exit.Size()))
...
func init() { proto.RegisterFile("proto/process/events.proto", fileDescriptorEvents) }

var fileDescriptorEvents = []byte{
	// 516 bytes of a gzipped FileDescriptorProto
	,
}
