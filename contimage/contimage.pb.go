...
type ContainerImage struct {
	...
	// Logical regular-file bytes across all layers, including versions hidden by
	// later layers. Same-layer hardlinks count once. Excludes archive and filesystem
	// overhead, symlinks, config and manifest. Absent when collection is unavailable.
	UncompressedSize *uint64 `protobuf:"varint,14,opt,name=uncompressed_size,json=uncompressedSize,proto3,oneof" json:"uncompressed_size,omitempty"`
}
...
func (x *ContainerImage) GetUncompressedSize() uint64 {
...
type ContainerImage_ContainerImageLayer struct {
	...
	// Logical file bytes stored in this layer that later layers of this image
	// hide through deletion or replacement. Absent when collection is unavailable.
	HiddenBytes *uint64 `protobuf:"varint,6,opt,name=hidden_bytes,json=hiddenBytes,proto3,oneof" json:"hidden_bytes,omitempty"`
}
...
func (x *ContainerImage_ContainerImageLayer) GetHiddenBytes() uint64 {
...
var file_proto_contimage_contimage_proto_rawDesc = []byte{
	...
	0x22, 0xf6, 0x08, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x6d,
	...
	,
	...
	0x68, 0x69, 0x74, 0x65, 0x63, 0x74, 0x75, 0x72, 0x65, 0x1a, 0xb7, 0x03, 0x0a, 0x13, 0x43, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x4c, 0x61, 0x79, 0x65,
	...
	0x07, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x26, 0x0a, 0x0c, 0x68, 0x69, 0x64, 0x64,
	0x65, 0x6e, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00,
	0x52, 0x0b, 0x68, 0x69, 0x64, 0x64, 0x65, 0x6e, 0x42, 0x79, 0x74, 0x65, 0x73, 0x88, 0x01, 0x01,
	0x1a, 0xaf, 0x01, 0x0a, 0x07, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x34, 0x0a, 0x07,
	...
	0x6e, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x4c, 0x61, 0x79, 0x65, 0x72,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x4c, 0x61, 0x79,
	0x65, 0x72, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x68, 0x69, 0x64, 0x64, 0x65, 0x6e, 0x5f, 0x62, 0x79,
	0x74, 0x65, 0x73, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65,
	0x64, 0x41, 0x74, 0x42, 0x14, 0x0a, 0x12, 0x5f, 0x75, 0x6e, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65,
	0x73, 0x73, 0x65, 0x64, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74,
	...
	0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
func file_proto_contimage_contimage_proto_init() {
	...
	file_proto_contimage_contimage_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
