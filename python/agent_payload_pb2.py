...
_ORIGIN = _descriptor.Descriptor(
  name='Origin',
  full_name='datadog.agentpayload.Origin',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_METADATA = _descriptor.Descriptor(
  name='Metadata',
  full_name='datadog.agentpayload.Metadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='origin', full_name='datadog.agentpayload.Metadata.origin', index=0,
...
_METRICPAYLOAD_METRICSERIES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='datadog.agentpayload.MetricPayload.MetricSeries.metadata', index=8,
...
_SKETCHPAYLOAD_SKETCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='datadog.agentpayload.SketchPayload.Sketch.metadata', index=5,
...
_METRICPAYLOAD_METRICSERIES.fields_by_name['metadata'].message_type = _METADATA
...
_SKETCHPAYLOAD_SKETCH.fields_by_name['metadata'].message_type = _METADATA
...
Origin = _reflection.GeneratedProtocolMessageType('Origin', (_message.Message,), dict(
  DESCRIPTOR = _ORIGIN,
  __module__ = 'agent_payload_pb2'
  # @@protoc_insertion_point(class_scope:datadog.agentpayload.Origin)
  ))
...
Metadata = _reflection.GeneratedProtocolMessageType('Metadata', (_message.Message,), dict(
  ...
  __module__ = 'agent_payload_pb2'
  # @@protoc_insertion_point(class_scope:datadog.agentpayload.Metadata)
  ))
