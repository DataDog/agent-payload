...
func (m *ProcessActivityNode) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.GenerationType != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.GenerationType))
		i--
		dAtA[i] = 0x40
	}
	if len(m.Syscalls) > 0 {
...
func (m *ProcessInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Cookie64 != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Cookie64))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	...
	if len(m.Argv0) > 0 {
		i -= len(m.Argv0)
		copy(dAtA[i:], m.Argv0)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Argv0)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
	...
	if m.ExecTime != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ExecTime))
		i--
		dAtA[i] = 0x70
	}
	if m.ExitTime != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ExitTime))
		i--
		dAtA[i] = 0x68
	}
	if m.ForkTime != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ForkTime))
		i--
		dAtA[i] = 0x60
	}
	if len(m.Comm) > 0 {
	...
	if len(m.Tty) > 0 {
		i -= len(m.Tty)
		copy(dAtA[i:], m.Tty)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Tty)))
		i--
		dAtA[i] = 0x52
	}
	if m.TraceId != 0 {
	...
	if m.Tid != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Tid))
		i--
		dAtA[i] = 0x10
	}
	if m.Pid != 0 {
...
func (m *OpenNode) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Retval != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64((uint64(m.Retval)<<1)^uint64((m.Retval>>63))))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *FileInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HashState != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.HashState))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if len(m.PackageSrcversion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PackageSrcversion)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
	...
	if m.MountId != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.MountId))
		i--
		dAtA[i] = 0x40
	}
	if m.Mtime != 0 {
...
func (m *Credentials) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CapPermitted != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.CapPermitted))
		i--
		dAtA[i] = 0x70
	}
	if m.CapEffective != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.CapEffective))
		i--
		dAtA[i] = 0x68
	}
	if len(m.FsGroup) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FsGroup)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.FsUser) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FsUser)))
		i--
		dAtA[i] = 0x5a
	}
	if m.FsGid != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.FsGid))
		i--
		dAtA[i] = 0x50
	}
	if m.FsUid != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.FsUid))
		i--
		dAtA[i] = 0x48
	}
	if len(m.EffectiveGroup) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EffectiveGroup)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.EffectiveUser) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EffectiveUser)))
		i--
		dAtA[i] = 0x3a
	}
	if m.EffectiveGid != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.EffectiveGid))
		i--
		dAtA[i] = 0x30
	}
	if m.EffectiveUid != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.EffectiveUid))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Group) > 0 {
...
func (m *ProcessActivityNode) SizeVT() (n int) {
	...
	if m.GenerationType != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.GenerationType))
	}
	if len(m.MatchedRules) > 0 {
...
func (m *ProcessInfo) SizeVT() (n int) {
	...
	if m.Tid != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Tid))
	}
	if m.Ppid != 0 {
	...
	if m.ForkTime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ForkTime))
	}
	if m.ExitTime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ExitTime))
	}
	if m.ExecTime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ExecTime))
	}
	if m.Credentials != nil {
	...
	if m.Cookie64 != 0 {
		n += 2 + protohelpers.SizeOfVarint(uint64(m.Cookie64))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *OpenNode) SizeVT() (n int) {
	...
	_ = l
	if m.Retval != 0 {
		n += 1 + protohelpers.SizeOfZigzag(uint64(m.Retval))
	}
	if m.Flags != 0 {
...
func (m *FileInfo) SizeVT() (n int) {
	...
	if m.Ctime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Ctime))
	}
	if m.Mtime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Mtime))
	}
	if m.MountId != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.MountId))
	}
	if m.Inode != 0 {
	...
	if m.HashState != 0 {
		n += 2 + protohelpers.SizeOfVarint(uint64(m.HashState))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *Credentials) SizeVT() (n int) {
	...
	if m.EffectiveUid != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.EffectiveUid))
	}
	if m.EffectiveGid != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.EffectiveGid))
	}
	...
	if m.FsUid != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.FsUid))
	}
	if m.FsGid != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.FsGid))
	}
	l = len(m.FsUser)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	...
	if m.CapEffective != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.CapEffective))
	}
	if m.CapPermitted != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.CapPermitted))
	}
	n += len(m.unknownFields)
	return n
}
