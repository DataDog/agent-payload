...
type ProcessActivityNode struct {
	...
	FirstSeen      uint64               `protobuf:"varint,14,opt,name=first_seen,json=firstSeen,proto3" json:"first_seen,omitempty"`
	LastSeen       uint64               `protobuf:"varint,15,opt,name=last_seen,json=lastSeen,proto3" json:"last_seen,omitempty"`
}
...
func (x *ProcessActivityNode) GetFirstSeen() uint64 {
	if x != nil {
		return x.FirstSeen
	}
	return 0
...
func (x *ProcessActivityNode) GetLastSeen() uint64 {
	if x != nil {
		return x.LastSeen
	}
	return 0
...
var file_proto_cws_dumpsv1_activity_dump_proto_rawDesc = []byte{
	...
	0x22, 0xb8, 0x06, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x41, 0x63, 0x74, 0x69,
	...
	0x72, 0x6b, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x72,
	0x73, 0x74, 0x5f, 0x73, 0x65, 0x65, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x66,
	0x69, 0x72, 0x73, 0x74, 0x53, 0x65, 0x65, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x73, 0x65, 0x65, 0x6e, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x6c, 0x61, 0x73,
	0x74, 0x53, 0x65, 0x65, 0x6e, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x9d, 0x05, 0x0a, 0x0b,
