...
func (m *PatternDefine) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ParamCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ParamCount))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Template) > 0 {
	...
	if m.PatternId != 0 {
		i = encodeVarint(dAtA, i, uint64(m.PatternId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Log) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Timestamp != 0 {
		i = encodeVarint(dAtA, i, uint64((uint64(m.Timestamp)<<1)^uint64((m.Timestamp>>63))))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *StructuredLog) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.JsonContext) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.JsonContext)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *DynamicValue_DictIndex) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.DictIndex))
	i--
	dAtA[i] = 0x20
	return len(dAtA) - i, nil
}
...
func (m *StatefulBatch) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.BatchId != 0 {
		i = encodeVarint(dAtA, i, uint64(m.BatchId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
